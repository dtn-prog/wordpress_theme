...
/* harmony import */ var _modules_MyNote__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/MyNote */ "./src/modules/MyNote.js");
...
const myNote = new _modules_MyNote__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
class MyNote {
  ...
  createNote(e) {
    ...
    let noteContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".new-note-body");
    let newPost = {
      'title': noteTitle.val(),
...
class Search {
  ...
  getResults() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(query, results => {
      this.reSultDiv.html(`
                <div class="row">
                    <div class="one-third">
